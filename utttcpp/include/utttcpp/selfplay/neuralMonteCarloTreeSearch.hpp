#ifndef UTTTCPP_SELFPLAY_NEURALMONTECARLOTREESEARCH_HPP_
#define UTTTCPP_SELFPLAY_NEURALMONTECARLOTREESEARCH_HPP_
...
class NeuralMonteCarloTreeSearch {
  public:
    ...
    NeuralMonteCarloTreeSearch(UltimateTicTacToe *uttt,
                               int numSimulations,
                               double explorationStrength,
                               torch::jit::script::Module policyValueNet);
  ...
  private:
    ...
    torch::Tensor getUtttStateTensor(const UltimateTicTacToe *uttt);
};

}  // namespace utttcpp

#endif  // UTTTCPP_SELFPLAY_NEURALMONTECARLOTREESEARCH_HPP_
