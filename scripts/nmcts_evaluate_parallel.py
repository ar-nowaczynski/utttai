...
def nmcts_worker(
    ...
    while True:
        ...
        print(f"nmcts_worker[{worker_id}]: evaluation saved to {output_path} successfully!")

        idle_queue.put(worker_id)


def nmcts_evaluate_parallel(
    ...
    print("nmcts_evaluate_parallel has finished successfully!")
